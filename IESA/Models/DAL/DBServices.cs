...
namespace IESA.Models.DAL
{
    public class DBServices
    {
        ...
        public List<GamesCategories> GetGameCategoriesr()
        {
            ...
            try
            {
                ...
                {   // Read till the end of the data into a row
                    ...
                    //if (g.Status1 == 1) { g.Status1 = (string)dr["פעיל"]}
                    //else { g.Status1 == "מושבת"}
                    gList.Add(g);
                }
        ...
        private String BuildInsertCommand(GamesCategories GameC)
        {
            ...
            //צריך להוסיף פה שאם המשחק קיים כבר במערכת, אז לא ניתן להוסיף
            command = prefix + sb.ToString();
        ...
        private String BuildInsertCommand7(int id,string UpdateCategoryName) //The second C
        {
                ...
                return ("UPDATE GamesCategories SET categoryName ="+UpdateCategoryName + " WHERE categoryID= " + id);
